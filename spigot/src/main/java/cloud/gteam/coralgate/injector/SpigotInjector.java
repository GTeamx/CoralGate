...
public class SpigotInjector {
    ...
    public void inject() {
        ...
        if (serverConnection != null) {
            ...
            final ReflectionObject reflectServerConnection = new ReflectionObject(serverConnection);
            final List<ChannelFuture> connectionChannelFutures = reflectServerConnection.readList(this.connectionChannelsListIndex);
            final InjectedList<ChannelFuture> wrappedList = new InjectedList<>(connectionChannelFutures, future -> {
    ...
    public void uninject() {
        ...
        if (serverConnection != null) {
            ...
            if (connectionChannelFutures instanceof InjectedList) {
                ...
                reflectServerConnection.writeList(this.connectionChannelsListIndex, ((InjectedList<ChannelFuture>) connectionChannelFutures).originalList());
